...
describe("unigData", function () {
  ...
  describe("Integration of Data in LocalStorage", function () {

    //Spec for sum operation
    it("should never be more then in FileList", function () {
   //   expect(Drupal.behaviors.unigData.FileList.sum(3, 5)).toEqual(8);
    });
